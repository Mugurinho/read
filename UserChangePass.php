			...
			<b>Welcome, </b>  <?php echo $_SESSION ['Username'];?>
			   <!--not to be moved above-->
                <div class="col-lg-12">
                    ...
                    <hr>
<form role="form" method="post" action="UserChangePassScript.php" enctype="multipart/form-data" accept-charset='UTF-8'>
<div class="row">
...
<label>New password</label>
    ...
    <button type="submit" name="Submit" class="btn btn-default"><span class="glyphicon glyphicon-thumbs-up"></span>&nbsp&nbspUpdate</button>
